...
path = r"D:\NguyenCuong\1A\FT672\process\orange\img\NG (3).png"
# path = r"D:\NguyenCuong\1A\FT672\process\orange\img\OK (11).png"
temp_L = cv2.imread(r"D:\NguyenCuong\1A\FT672\process\orange\img\template.png", cv2.IMREAD_GRAYSCALE)
THRESHOLD_VALUE = 13
A = 2
HEIGHT_AREA = 40
HEIGHT_3RD_AREA = 45
